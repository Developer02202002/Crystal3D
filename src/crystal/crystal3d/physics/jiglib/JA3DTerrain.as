package crystal.crystal3d.physics.jiglib
{
	 ...
	 * @public
	 * @author redefy, (modified for JigLib)
	 */
	public class JA3DTerrain extends Mesh implements ITerrain
	{
		 ...
		 */
		public function JA3DTerrain(material:Material, heightMap:BitmapData, width:Number = 1000, height:Number = 100, depth:Number = 1000, segmentsW:uint = 30, segmentsH:uint = 30, maxElevation:uint = 255, minElevation:uint = 0, smoothMap:Boolean = false)
		{
			super();
		...
		// JigLib ITerrain getters.
		public function get minW():Number { return _minW; }
		public function get minH():Number { return _minH; }
		public function get maxW():Number { return -_minW; }
		public function get maxH():Number { return -_minH; }
