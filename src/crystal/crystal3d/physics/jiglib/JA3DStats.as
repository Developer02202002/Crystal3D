package crystal.crystal3d.physics.jiglib {
	...
	public class JA3DStats extends Sprite {
		 ...
		 */
		public function JA3DStats(camera : Camera3D, physics : AbstractPhysics, grid : Boolean = false) : void {
			this.camera = camera;
		...
		private function update(e : Event) : void {
			...
			if ( timer - 1000 > ms_prev ) {
				...
				textFps.htmlText = fps + " / " + stage.frameRate + "<br>" + PhysicsSystem.getInstance().getCollisionSystem().numCollisionsChecks + "<br>" + camera.alternativa3d::numTriangles;
